...
| Project presentation | in-class presentation | 15 %                   |
...
-   Reusing code: You may make use of online resources (e.g. StackOverflow, ChatGPT, or other LLMs) for coding examples on assignments, with two caveats: first, if you directly use code from an outside source, you must explicitly cite where you obtained the code
