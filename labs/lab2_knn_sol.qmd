...
1.  Clean the data to remove any outliers or missing values in these variables, and select all the variables except for \`sample id\`. Split the data set into training and test sets.

    ```{r}
    neuro_data <- neuro_blast |> select(-`sample id`) |> drop_na()
