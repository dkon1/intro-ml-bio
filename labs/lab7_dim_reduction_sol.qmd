...
6.  Perform PCA on the raw (unscaled) data and make a Scree plot of the eigenvalues. Plot the data points projected onto the first two principalcomponents colored by `class`.
...
7.  Perform PCA on the scaled variables and make a Scree plot of the eigenvalues. Plot the data points projected onto the first two principalcomponents colored by their `class`.
