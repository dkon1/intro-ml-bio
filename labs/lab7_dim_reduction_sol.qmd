...
fviz_cluster(list(data = wisc_pred, cluster = wisc_class$Diagnosis),
ellipse.type = "norm", geom = "point", stand = FALSE, palette = "jco", ggtheme = theme_classic())

#kmeans_fit |>  accuracy(truth = high_risk, estimate = .pred_class)

#kmeans_fit |>  conf_mat(truth = high_risk, estimate = .pred_class)
