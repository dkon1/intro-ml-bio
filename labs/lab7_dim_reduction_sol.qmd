...
6.  Perform PCA on the raw (unscaled) data and make a Scree plot of the eigenvalues. Plot the data points projected onto the first principal components colored by `class`.
...
7.  Perform PCA on the scaled variables and make a Scree plot of the eigenvalues. Plot the data points projected onto the first principal components colored by their `class`.
...
10\. Try using other linkage methods (e.g. "complete" and "average") and report the same confusion matrix for both.
